...
export default {
  ...
  methods: {
    ...
    async getMovies () {
      ...
      const data = axios.get('https://api.themoviedb.org/3/movie/now_playing?api_key=46b82d06a9b6224b0531c70bab82b005&language=en-US&page=1')
    ...
    async searchMovies () {
      // eslint-disable-next-line no-unused-vars
      const data = axios.get(`https://api.themoviedb.org/3/search/movie?api_key=46b82d06a9b6224b0531c70bab82b005&query=${this.searchInput}`)
      const result = await data
      result.data.results.forEach((movie) => {
